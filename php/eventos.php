...
<body>
    ...
    <main class="pagina-eventos">
        ...
        <div class="accion-boton">
            <a href="todos-eventos.php" class="boton-amarillo">Ver todos los eventos</a>
        </div>
        ...
        <section class="seccion seccion-foco">
            ...
            <div class="accion-boton secundaria">
                <a href="anteriores-eventos.php" class="boton-amarillo">Ver eventos anteriores</a>
            </div>
        </section>
